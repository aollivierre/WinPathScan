...
"@
        ...
        New-HTMLSection -HeaderText "Long Paths Details" {
            New-HTMLTable -DataTable $Results -ScrollX -SearchBuilder -Buttons @('copyHtml5', 'excelHtml5', 'csvHtml5', 'searchBuilder')
        }
...
# Example usage:
Get-LongPathAnalysis -Path "C:\code" -Limit 260 -ExportFormat "Both" -IncludePermissions